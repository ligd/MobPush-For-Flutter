...
class MobpushPlugin {
  static const MethodChannel _channel =
      const MethodChannel('mob.com/mobpush_plugin');
  ...
  static Future<bool> updatePrivacyPermissionStatus(bool agree) async {
    return await _channel
        .invokeMethod("updatePrivacyPermissionStatus", {"status": agree});
  }
  ...
  static Future<Map<String, dynamic>> send(
      int type, String content, int space, String extras) async {
